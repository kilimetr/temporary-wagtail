...
def Globus_main_fun():
	...
	source_letaky = requests.get("https://www.kupi.cz/letaky/globus#sgc=globus", 
								 headers = headers)
	...
	for letak in letaky:
		LetakPrahaZlicin = letak.find("strong", itemprop = "name").text
		LetakPrahaZlicin = str(LetakPrahaZlicin)

		response = "leták Praha - Zličín" in LetakPrahaZlicin
