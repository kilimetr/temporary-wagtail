$(document).ready(function() {
    ...
    // const btn    = document.querySelectorAll("[id=add-to-basket-btn]");
    // const select = document.querySelectorAll("[id=variant-select]");
    // const qty    = document.querySelectorAll("[id=item-quantity-to-basket]");

    // querySelectorAll("[id=variant-select")
