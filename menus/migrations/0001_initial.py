# Generated by Django 3.1.4 on 2021-01-15 17:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='menu_polozky', to='menus.menu')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
